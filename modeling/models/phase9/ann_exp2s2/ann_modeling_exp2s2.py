...
DATASETS = [
    {
        "name":       "grab_BOD",
        "file":       os.path.join(DS_DIR, "grab_BOD.xlsx"),
        "target":     "Effluent BOD (mg/L, Grab)",
        "experiment": "ANN-Exp2-Sub2",
    },
    {
        "name":       "grab_COD",
        "file":       os.path.join(DS_DIR, "grab_COD.xlsx"),
        "target":     "Effluent COD (mg/L, Grab)",
        "experiment": "ANN-Exp2-Sub2",
    },
    {
        "name":       "grab_TSS",
        "file":       os.path.join(DS_DIR, "grab_TSS.xlsx"),
        "target":     "Effluent TSS (mg/L, Grab)",
        "experiment": "ANN-Exp2-Sub2",
    },
    {
        "name":       "grab_pH",
        "file":       os.path.join(DS_DIR, "grab_pH.xlsx"),
        "target":     "Effluent pH (Grab)",
        "experiment": "ANN-Exp2-Sub2",
    },
    {
        "name":       "comp_BOD",
        "file":       os.path.join(DS_DIR, "comp_BOD.xlsx"),
        "target":     "Effluent BOD (mg/L, Composite)",
        "experiment": "ANN-Exp2-Sub2",
    },
    {
        "name":       "comp_COD",
        "file":       os.path.join(DS_DIR, "comp_COD.xlsx"),
        "target":     "Effluent COD (mg/L, Composite)",
        "experiment": "ANN-Exp2-Sub2",
    },
    {
        "name":       "comp_TSS",
        "file":       os.path.join(DS_DIR, "comp_TSS.xlsx"),
        "target":     "Effluent TSS (mg/L, Composite)",
        "experiment": "ANN-Exp2-Sub2",
    },
    {
        "name":       "comp_pH",
        "file":       os.path.join(DS_DIR, "comp_pH.xlsx"),
