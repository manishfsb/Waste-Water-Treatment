"""
non_linear_modeling_exp9_s1.py - RF, GB, XGBoost on Experiment 9 SE1 datasets.
...
Usage (from project root):
    .venv/bin/python3 modeling/models/non_linear/exp9_s1/non_linear_modeling_exp9_s1.py
"""
...
# ── Registry ───────────────────────────────────────────────────────────────────
REGISTRY = [
    ("Exp9-SE1", "grab_BOD", _ds("grab_BOD"), "Effluent BOD (mg/L, Grab)"),
    ("Exp9-SE1", "grab_COD", _ds("grab_COD"), "Effluent COD (mg/L, Grab)"),
    ("Exp9-SE1", "grab_TSS", _ds("grab_TSS"), "Effluent TSS (mg/L, Grab)"),
    ("Exp9-SE1", "grab_pH",  _ds("grab_pH"),  "Effluent pH (Grab)"),
    ("Exp9-SE1", "comp_BOD", _ds("comp_BOD"), "Effluent BOD (mg/L, Composite)"),
    ("Exp9-SE1", "comp_COD", _ds("comp_COD"), "Effluent COD (mg/L, Composite)"),
    ("Exp9-SE1", "comp_TSS", _ds("comp_TSS"), "Effluent TSS (mg/L, Composite)"),
    ("Exp9-SE1", "comp_pH",  _ds("comp_pH"),  "Effluent pH (Composite)"),
]
...
def run_model(model_tag, search_factory):
    ...
    print(f"\n{'='*65}")
    print(f"  {model_tag} (Exp9-SE1, W1: 2024-only) - run {run}")
    print(f"{'='*65}")
...
def main():
    ...
    print("\n" + "="*65)
    print("  Exp9-SE1 (W1: 2024-only)  -  all models complete.")
