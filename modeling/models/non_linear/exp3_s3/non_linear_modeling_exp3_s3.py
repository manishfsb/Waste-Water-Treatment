"""
non_linear_modeling_exp3_s3.py - RF, GB, XGBoost on Experiment 3 Sub-3, no FS.
...
Usage (from project root):
    .venv/bin/python3 modeling/models/non_linear/exp3_s3/non_linear_modeling_exp3_s3.py
"""
...
REGISTRY = [
    ("Exp3-S3", "grab_BOD", _ds("grab_BOD"), "Effluent BOD (mg/L, Grab)"),
    ("Exp3-S3", "grab_COD", _ds("grab_COD"), "Effluent COD (mg/L, Grab)"),
    ("Exp3-S3", "grab_TSS", _ds("grab_TSS"), "Effluent TSS (mg/L, Grab)"),
    ("Exp3-S3", "grab_pH",  _ds("grab_pH"),  "Effluent pH (Grab)"),
    ("Exp3-S3", "comp_BOD", _ds("comp_BOD"), "Effluent BOD (mg/L, Composite)"),
    ("Exp3-S3", "comp_COD", _ds("comp_COD"), "Effluent COD (mg/L, Composite)"),
    ("Exp3-S3", "comp_TSS", _ds("comp_TSS"), "Effluent TSS (mg/L, Composite)"),
    ("Exp3-S3", "comp_pH",  _ds("comp_pH"),  "Effluent pH (Composite)"),
]
...
def run_model(model_tag, search_factory):
    ...
    print(f"\n{'='*65}")
    print(f"  {model_tag} (Exp3-S3, ADD+CONSIDER minus Coliform, no FS) - run {run}")
    print(f"{'='*65}")
...
def main():
    ...
    print("\n" + "="*65)
    print("  Exp3-S3 (ADD+CONSIDER minus Coliform, no FS)  -  all models complete.")
