"""
non_linear_modeling_exp3_s4.py - RF, GB, XGBoost on Experiment 3 All Features (SE4) subsets.
...
Usage (from project root):
    .venv/bin/python3 modeling/models/non_linear/exp3_s4/non_linear_modeling_exp3_s4.py
"""
