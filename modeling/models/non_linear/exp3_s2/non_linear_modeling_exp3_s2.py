"""
non_linear_modeling_exp3_s2.py - RF, GB, XGB on Experiment 3 Sub-2 (OOF FS).
...
Experiment key: Exp3-S2-FS

Usage (from project root):
    .venv/bin/python3 modeling/models/non_linear/exp3_s2/non_linear_modeling_exp3_s2.py
"""
...
# ── Dataset registry ───────────────────────────────────────────────────────────
REGISTRY = [
    ("Exp3-S2-FS", "grab_BOD", _ds("grab_BOD"), "Effluent BOD (mg/L, Grab)"),
    ("Exp3-S2-FS", "grab_COD", _ds("grab_COD"), "Effluent COD (mg/L, Grab)"),
    ("Exp3-S2-FS", "grab_TSS", _ds("grab_TSS"), "Effluent TSS (mg/L, Grab)"),
    ("Exp3-S2-FS", "grab_pH",  _ds("grab_pH"),  "Effluent pH (Grab)"),
    ("Exp3-S2-FS", "comp_BOD", _ds("comp_BOD"), "Effluent BOD (mg/L, Composite)"),
    ("Exp3-S2-FS", "comp_COD", _ds("comp_COD"), "Effluent COD (mg/L, Composite)"),
    ("Exp3-S2-FS", "comp_TSS", _ds("comp_TSS"), "Effluent TSS (mg/L, Composite)"),
    ("Exp3-S2-FS", "comp_pH",  _ds("comp_pH"),  "Effluent pH (Composite)"),
]
