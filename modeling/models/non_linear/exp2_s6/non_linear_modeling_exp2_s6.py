"""
non_linear_modeling_exp2_s6.py - RF, GB, XGBoost on Experiment 2 SE2a: All Secondary only.
...
Usage (from project root):
    .venv/bin/python3 modeling/models/non_linear/exp2_s6/non_linear_modeling_exp2_s6.py
"""
...
REGISTRY = [
    ("Exp2-S6", "grab_BOD", _ds("grab_BOD"), "Effluent BOD (mg/L, Grab)"),
    ("Exp2-S6", "grab_COD", _ds("grab_COD"), "Effluent COD (mg/L, Grab)"),
    ("Exp2-S6", "grab_TSS", _ds("grab_TSS"), "Effluent TSS (mg/L, Grab)"),
    ("Exp2-S6", "grab_pH",  _ds("grab_pH"),  "Effluent pH (Grab)"),
    ("Exp2-S6", "comp_BOD", _ds("comp_BOD"), "Effluent BOD (mg/L, Composite)"),
    ("Exp2-S6", "comp_COD", _ds("comp_COD"), "Effluent COD (mg/L, Composite)"),
    ("Exp2-S6", "comp_TSS", _ds("comp_TSS"), "Effluent TSS (mg/L, Composite)"),
    ("Exp2-S6", "comp_pH",  _ds("comp_pH"),  "Effluent pH (Composite)"),
]
...
def run_model(model_tag, search_factory):
    ...
    print(f"\n{'='*65}")
    print(f"  {model_tag} (Exp2-SE2a, All Secondary only, 10 feat) - run {run}")
    print(f"{'='*65}")
...
def main():
    ...
    print("\n" + "="*65)
    print("  Exp2-SE2a (All Secondary only, 10 feat)  -  all models complete.")
