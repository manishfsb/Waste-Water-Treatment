"""
non_linear_modeling_exp5_s1.py - RF, GB, XGBoost on Experiment 5 Sub-1.
...
Usage (from project root):
    .venv/bin/python3 modeling/models/non_linear/exp5_s1/non_linear_modeling_exp5_s1.py
"""
...
REGISTRY = [
    ("Exp5-S1", "comp_BOD", _ds("comp_BOD"), "Effluent BOD (mg/L, Composite)"),
    ("Exp5-S1", "comp_COD", _ds("comp_COD"), "Effluent COD (mg/L, Composite)"),
    ("Exp5-S1", "comp_TSS", _ds("comp_TSS"), "Effluent TSS (mg/L, Composite)"),
    ("Exp5-S1", "comp_pH",  _ds("comp_pH"),  "Effluent pH (Composite)"),
]
...
def run_model(model_tag, search_factory):
    ...
    print(f"\n{'='*65}")
    print(f"  {model_tag} (Exp5-S1, Composite + Grab Inlet) - run {run}")
    print(f"{'='*65}")
...
def main():
    ...
    print("\n" + "="*65)
    print("  Exp5-S1  -  all models complete.")
