...
REGISTRY = [
    # Experiment 1 - Grab
    ("Experiment 1", "grab_BOD",
     _sub("experiment1_fs", "grab_BOD"), "Effluent BOD (mg/L, Grab)"),
    ("Experiment 1", "grab_COD",
     _sub("experiment1_fs", "grab_COD"), "Effluent COD (mg/L, Grab)"),
    ("Experiment 1", "grab_TSS",
     _sub("experiment1_fs", "grab_TSS"), "Effluent TSS (mg/L, Grab)"),
    ("Experiment 1", "grab_pH",
     _sub("experiment1_fs", "grab_pH"),  "Effluent pH (Grab)"),
    # Experiment 1 - Composite
    ("Experiment 1", "comp_BOD",
     _sub("experiment1_fs", "comp_BOD"), "Effluent BOD (mg/L, Composite)"),
    ("Experiment 1", "comp_COD",
     _sub("experiment1_fs", "comp_COD"), "Effluent COD (mg/L, Composite)"),
    ("Experiment 1", "comp_TSS",
     _sub("experiment1_fs", "comp_TSS"), "Effluent TSS (mg/L, Composite)"),
    ("Experiment 1", "comp_pH",
     _sub("experiment1_fs", "comp_pH"),  "Effluent pH (Composite)"),
    # Experiment 2 Sub-1 - Grab
    ("Experiment 2 Sub-1", "grab_BOD",
     _sub("experiment2_s1_fs", "grab_BOD"), "Effluent BOD (mg/L, Grab)"),
    ("Experiment 2 Sub-1", "grab_COD",
     _sub("experiment2_s1_fs", "grab_COD"), "Effluent COD (mg/L, Grab)"),
    ("Experiment 2 Sub-1", "grab_TSS",
     _sub("experiment2_s1_fs", "grab_TSS"), "Effluent TSS (mg/L, Grab)"),
    ("Experiment 2 Sub-1", "grab_pH",
     _sub("experiment2_s1_fs", "grab_pH"),  "Effluent pH (Grab)"),
    # Experiment 2 Sub-1 - Composite
    ("Experiment 2 Sub-1", "comp_BOD",
     _sub("experiment2_s1_fs", "comp_BOD"), "Effluent BOD (mg/L, Composite)"),
    ("Experiment 2 Sub-1", "comp_COD",
     _sub("experiment2_s1_fs", "comp_COD"), "Effluent COD (mg/L, Composite)"),
    ("Experiment 2 Sub-1", "comp_TSS",
     _sub("experiment2_s1_fs", "comp_TSS"), "Effluent TSS (mg/L, Composite)"),
    ("Experiment 2 Sub-1", "comp_pH",
     _sub("experiment2_s1_fs", "comp_pH"),  "Effluent pH (Composite)"),
    # Experiment 2 Sub-2 - Grab
    ("Experiment 2 Sub-2", "grab_BOD",
     _sub("experiment2_s2_fs", "grab_BOD"), "Effluent BOD (mg/L, Grab)"),
    ("Experiment 2 Sub-2", "grab_COD",
     _sub("experiment2_s2_fs", "grab_COD"), "Effluent COD (mg/L, Grab)"),
    ("Experiment 2 Sub-2", "grab_TSS",
     _sub("experiment2_s2_fs", "grab_TSS"), "Effluent TSS (mg/L, Grab)"),
    ("Experiment 2 Sub-2", "grab_pH",
     _sub("experiment2_s2_fs", "grab_pH"),  "Effluent pH (Grab)"),
    # Experiment 2 Sub-2 - Composite
    ("Experiment 2 Sub-2", "comp_BOD",
     _sub("experiment2_s2_fs", "comp_BOD"), "Effluent BOD (mg/L, Composite)"),
    ("Experiment 2 Sub-2", "comp_COD",
     _sub("experiment2_s2_fs", "comp_COD"), "Effluent COD (mg/L, Composite)"),
    ("Experiment 2 Sub-2", "comp_TSS",
     _sub("experiment2_s2_fs", "comp_TSS"), "Effluent TSS (mg/L, Composite)"),
    ("Experiment 2 Sub-2", "comp_pH",
     _sub("experiment2_s2_fs", "comp_pH"),  "Effluent pH (Composite)"),
]
