"""
linear_modeling_exp3_s4.py - OLS, Ridge, and ElasticNet on Experiment 3 All Features (SE4) subsets.
...
Datasets: experiment3/sub_exp4/ (built by make_sub4_datasets.py)
Exp key: Exp3-S4

Usage (from project root):
    .venv/bin/python3 modeling/models/linear/exp3_s4/linear_modeling_exp3_s4.py
"""
...
DATASETS = [
    ...
    ("Exp3-S4", "Exp3S3_Grab_BOD", _e3ks("grab_BOD"), "Effluent BOD (mg/L, Grab)"),
    ("Exp3-S4", "Exp3S3_Grab_COD", _e3ks("grab_COD"), "Effluent COD (mg/L, Grab)"),
    ("Exp3-S4", "Exp3S3_Grab_TSS", _e3ks("grab_TSS"), "Effluent TSS (mg/L, Grab)"),
    ("Exp3-S4", "Exp3S3_Grab_pH",  _e3ks("grab_pH"),  "Effluent pH (Grab)"),
    # ── Experiment 3 KS - Composite ──────────────────────────────────────────
    ("Exp3-S4", "Exp3S3_Comp_BOD", _e3ks("comp_BOD"), "Effluent BOD (mg/L, Composite)"),
    ("Exp3-S4", "Exp3S3_Comp_COD", _e3ks("comp_COD"), "Effluent COD (mg/L, Composite)"),
    ("Exp3-S4", "Exp3S3_Comp_TSS", _e3ks("comp_TSS"), "Effluent TSS (mg/L, Composite)"),
    ("Exp3-S4", "Exp3S3_Comp_pH",  _e3ks("comp_pH"),  "Effluent pH (Composite)"),
]
