"""
linear_modeling_exp8_s2.py - OLS, Ridge, ElasticNet on Experiment 10 SE1 datasets.
...
Usage (from project root):
    .venv/bin/python3 modeling/models/linear/exp8_s2/linear_modeling_exp8_s2.py
"""
...
# -- Dataset registry ----------------------------------------------------------
def _ds(name):
    return os.path.join(MODELING_DIR, "datasets", "experiment8", "sub_exp2", f"{name}.xlsx")

DATASETS = [
    ("Exp8-SE2", "Exp8SE2_Grab_BOD", _ds("grab_BOD"), "Effluent BOD (mg/L, Grab)"),
    ("Exp8-SE2", "Exp8SE2_Grab_COD", _ds("grab_COD"), "Effluent COD (mg/L, Grab)"),
    ("Exp8-SE2", "Exp8SE2_Grab_TSS", _ds("grab_TSS"), "Effluent TSS (mg/L, Grab)"),
    ("Exp8-SE2", "Exp8SE2_Grab_pH",  _ds("grab_pH"),  "Effluent pH (Grab)"),
    ("Exp8-SE2", "Exp8SE2_Comp_BOD", _ds("comp_BOD"), "Effluent BOD (mg/L, Composite)"),
    ("Exp8-SE2", "Exp8SE2_Comp_COD", _ds("comp_COD"), "Effluent COD (mg/L, Composite)"),
    ("Exp8-SE2", "Exp8SE2_Comp_TSS", _ds("comp_TSS"), "Effluent TSS (mg/L, Composite)"),
    ("Exp8-SE2", "Exp8SE2_Comp_pH",  _ds("comp_pH"),  "Effluent pH (Composite)"),
]
...
def main():
    ...
    print(f"Linear Modeling  -  Exp8-SE2 (same-day features only)  -  Run {run}")
