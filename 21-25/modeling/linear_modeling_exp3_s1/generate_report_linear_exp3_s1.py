"""
generate_report_linear_exp3_s1.py — HTML report for Experiment 3 Sub-1 linear models.

Reads linear_modeling_exp3_s1/results.xlsx and the plots in linear_modeling_exp3_s1/plots/.
Produces linear_modeling_exp3_s1/report_linear_exp3_s1_run_N.html — a self-contained,
...
Usage (from project root):
    .venv/bin/python3 21-25/modeling/linear_modeling_exp3_s1/generate_report_linear_exp3_s1.py
"""
...
<head>
  ...
  <title>Linear Models Report — Experiment 3 Sub-1 | Run {run}</title>
...
<body>
  ...
  <h1>Linear Models Report — Experiment 3 Sub-1
  ...
  <div style="margin:10px 0 20px;padding:12px 16px;background:var(--obs-bg);border-radius:8px;font-size:0.88rem;color:var(--text);">
    ...
    Ridge (L2), and ElasticNet (L1+L2) — on Experiment 3 Sub-1 datasets
    (Exp2 Sub-2 baseline + ADD-tier candidate features per target). OLS is included
...
def main():
    ...
    out_path = os.path.join(SCRIPT_DIR, f"report_linear_exp3_s1_run_{run}.html")
