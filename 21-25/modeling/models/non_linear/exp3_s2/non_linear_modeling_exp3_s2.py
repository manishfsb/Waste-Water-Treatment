"""
non_linear_modeling_exp3_s2.py — RF, GB, XGBoost on Experiment 3 Sub-2 subsets.
...
Differences:
  ...
  - Writes all artifacts to models/non_linear/exp3_s2/{rf,gb,xgb}/

Usage (from project root):
    .venv/bin/python3 21-25/modeling/models/non_linear/exp3_s2/non_linear_modeling_exp3_s2.py
"""
...
def run_model(model_tag, search_factory):
    ...
    print(f"\n{'='*65}")
    print(f"  {model_tag} Exp3-S2 — run {run}")
    print(f"{'='*65}")
...
def main():
    ...
    print("\n" + "="*65)
    print("  All models complete (Exp3-S2, tuned).")
