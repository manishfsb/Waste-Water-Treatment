"""
generate_report_linear.py — HTML comparison report for linear models.

Reads linear_modeling/results.xlsx and the plots in linear_modeling/plots/.
Produces linear_modeling/report_linear_run_N.html — a self-contained,
...
<head>
  ...
  <title>Linear Models Report — Experiments 1 &amp; 2 | Run {run}</title>
...
<body>
  ...
  <h1>Linear Models Comparison Report
...
def main():
    ...
    out_path = os.path.join(SCRIPT_DIR, f"report_linear_run_{run}.html")
